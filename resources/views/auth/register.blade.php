            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="peso_base" class="col-md-4 col-form-label text-md-right">{{ __('Peso base (kg)') }}</label>

                            <div class="col-md-6">
                                <input id="peso_base" type="number" step="0.01" min="0" class="form-control @error('peso_base') is-invalid @enderror" name="peso_base" value="{{ old('peso_base') }}">
                        ...
                        <div class="form-group row">
                            <label for="altura_base" class="col-md-4 col-form-label text-md-right">{{ __('Altura base (cm)') }}</label>

                            <div class="col-md-6">
                                <input id="altura_base" type="number" min="0" class="form-control @error('altura_base') is-invalid @enderror" name="altura_base" value="{{ old('altura_base') }}">
